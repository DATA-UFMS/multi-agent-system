...
[ Organic Search Results  ](//ahrefs.com/seo/glossary/organic-search-results)

#  Organic Traffic 

##  What is Organic Traffic? 

Organic traffic refers to visitors who arrive at a website through unpaid, natural, and non-advertising channels. It primarily includes traffic originating from the organic search results of search engine results pages (SERPs). 

Organic traffic is highly sought after by webmasters due to its cost-effectiveness and typically high quality. The quality of organic search traffic stems from the fact that top search results are highly relevant to users’ queries and satisfy the search intent to a maximum degree. 

The primary objective of search engine optimization (SEO) is to drive a substantial volume of organic search traffic to a website. 
