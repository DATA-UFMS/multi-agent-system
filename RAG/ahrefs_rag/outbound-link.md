...
[ Orphan Page  ](//ahrefs.com/seo/glossary/orphan-page)

#  Outbound Link 

##  What is an Outbound Link? 

An outbound link (also known as an [ external link ](https://ahrefs.com/seo/glossary/external-link) ) is a hyperlink that directs users to a URL outside of your website. An outbound link from one website is considered an [ inbound link (or backlink) ](https://ahrefs.com/seo/glossary/inbound-link) for the website that is being linked to. 

Outbound links are commonly used for various reasons, including providing resources with additional and deeper information, referencing sources of information, and referencing products, particularly in affiliate marketing. 

Moreover, outbound links pass the so-called “link equity” to the linked web pages. They function as “votes” for search engines like Google. The more websites link to your content via outbound links, the more authority it gains. Pages with higher link authority tend to rank higher in Google’s search results. 

[ Page Speed  ](//ahrefs.com/seo/glossary/page-speed)
...
[ Contact us  ](/cdn-cgi/l/email-protection#493a3c3939263b3d0928213b2c2f3a672a2624)
