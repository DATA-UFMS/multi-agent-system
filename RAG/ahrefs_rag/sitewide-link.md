...
[ Sitemaps  ](//ahrefs.com/seo/glossary/sitemap)

#  Sitewide Link 

##  What is a Sitewide Link? 

A sitewide link is an outgoing link (internal or external) that appears on every page of a website. 

The most common examples of sitewide links are links the footer and the site navigation menu. 

Here’s an example of sitewide links on our blog: 

![Sitewide links on Ahrefs blog](https://ahrefs.com/blog/wp-content/uploads/2022/05/Sitewide-links-on-Ahrefs-blog.png)

In linkbuilding, sitewide links are backlinks from a website that appear on its every page. In most cases, such links are unnatural and thus violate the Google Spam Policies. 

[ Spamdexing  ](//ahrefs.com/seo/glossary/spamdexing)
