...
[ Unnatural Links  ](//ahrefs.com/seo/glossary/unnatural-links)

#  URL Rating (UR) 

##  What is URL Rating (UR)? 

URL Rating (UR) is an SEO metric developed by Ahrefs that represents the strength of the page’s backlink profile. It is measured on a logarithmic scale from 0 to 100, with the latter being the strongest. UR is somehow similar to Google’s PageRank. 
...
Only “ [ dofollow ](https://ahrefs.com/seo/glossary/dofollow-link) ” links pass UR. 

Our studies show that the URL Rating has a clear positive correlation with Google rankings. 

URL Rating is a page-level metric and should not be confused with [ Domain Rating (DR) ](https://ahrefs.com/seo/glossary/domain-rating) . 
...
[ Contact us  ](/cdn-cgi/l/email-protection#a1d2d4d1d1ced3d5e1c0c9d3c4c7d28fc2cecc)
